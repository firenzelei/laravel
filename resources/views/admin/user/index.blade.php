...
<div class="page-container">
	<div class="text-c">
		<input type="text" class="input-text" style="width:250px" placeholder="输入管理员名称" id="" name="uname" value="{{$request->uname}}">
	...
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td class="td-manage">
					<a title="编辑" href="javascript:;" onclick="admin_edit('管理员编辑','/admin/user/{{$v->id}}/edit','1','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
...
<script type="text/javascript" src="/admins/lib/datatables/1.10.0/jquery.dataTables.min.js"></script> 
<script type="text/javascript" src="/admins/lib/laypage/1.2/laypage.js"></script>
...
function admin_add(title,url,w,h){
	layer_show(title,'/admin/user/create',w,h);
}
/*管理员-删除*/
